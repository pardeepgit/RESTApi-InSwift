...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        /*
         // Code to set SVProgressHUD Forground color of circle.
         */
        SVProgressHUDBackgroundColor = [UIColor clearColor];
        SVProgressHUDForegroundColor = [UIColor whiteColor];//[UIColor colorWithRed:249.0/256.0 green:92.0/256.0 blue:6.0/256.0 alpha:1.0];
